...
<form name="login_form" action="" method="post">
								  <div class="form-group">
									...
									<input type="text" class="form-control" name="account" autofocus id="username" value="" placeholder="User name">
								  </div>
								  <div class="form-group"> 
                                   ...
                                   <br>
                                   <i class="fa fa-key"></i>
        <span style="width:70%;float:left;"><input name="mycode" type="text" class="form-control" id="mycode" title="Please enter the verification code" placeholder="Please enter the verification code" required ></span>  
        <span style="width:30%;" ><img src="/Home/login/verify.html" name="myHeader" height="35" id="myHeader" onClick="this.src='/Home/login/verify?'+Math.random();" /></span>
								  ...
								  <div>
									...
									<button  class="btn btn-danger" id="login_btn" type="button" name="submit">登录</button>
								  </div>
								</form>
								<!-- SOCIAL LOGIN -->
							  <div class="divide-20"></div>
								...
								<a href="/Home/Reg/forgot.html">Forgot Password?</a></div>
							</div>
						</div>
					</div>
				</div>
