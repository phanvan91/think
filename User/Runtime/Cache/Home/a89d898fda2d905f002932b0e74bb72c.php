...
<head>
   ...
   function jian(obj){
	  ...
	  var jian = parseInt($("#good"+obj).val());
	  if(jian <= 0){
	     $("#good"+obj).val(0);
	  }else{
	     jian -= 1;
...
<div id="floatDivBoxs">
    ...
    <div class="floatShadow">
        <ul class="floatDqq">
            <li style="padding-left:0px;list-style:none;"><a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=2274965293&site=qq&menu=yes"><img src="/Public/qq.png" align="absmiddle">&nbsp;&nbsp;在线客服1号</a></li>
            <li style="padding-left:0px;list-style:none;"><a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=2274965293&site=qq&menu=yes"><img src="/Public/qq.png" align="absmiddle">&nbsp;&nbsp;在线客服2号</a></li>
            <li style="padding-left:0px;list-style:none;"><a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=2274965293&site=qq&menu=yes"><img src="/Public/qq.png" align="absmiddle">&nbsp;&nbsp;在线客服3号</a></li>
        </ul>
...
<div class="container">
	...
	<div class="panel panel-default">
		...
		<h4 class="font-light m-b-xs">完成任务，获得对应奖励。每天限完成一次!</h4>
                <font style="font-size:14px;">
		
                    1、只有完成鸿基的每日任务，才能获得排单币！<br>
		    2、每个会员每天只能完成一次任务，完成后提交截图凭证，后台24小时内审核通过直接发放对应奖励。<br>
		    3、请各位会员严格遵守平台规则，如发现违规操作会员，一经发现永久封号！<br><br>
		    <p style="color:#ffff00;">鸿基为了给所有会员制造一个公平公正稳定的平台，所有对应奖励都是人工审核发放，虽然这样的工作量很大，但这就是
			鸿基控盘最严密的一道防线。最近平台发现有会员囤积对应奖励通过连续排单刷推荐奖和利息的作弊行为。平台已经监控到这样的现象，对于存在作弊嫌疑的帐号，
			鸿基将延后其对应奖励的审核发放。</p>
                </font>
	    </div>
	</div>
	...
	<div class="row">
	    ...
	    <div class="col-md-5">
				   ...
				   <div class="box border primary ">
											<div class="box-title">
												<h4><i class="fa fa-bars"></i><?php echo ($renwu1["if_theme"]); ?></h4>
                                           ...
                                           <div class="box-body big">
                                             <div class="p-sm">
			    <p class="vertical-date text-success"><small>长期有效</small></p>
			    <p><?php echo ($renwu1["if_content"]); ?></p>
			</div>
                         <?php if($renwu1["if_webimg"] != ''): ?><p><img alt="" src="<?php echo ($renwu1["if_webimg"]); ?>" style="width:250px;height:200px;"></p><?php endif; ?><br>
					 </div>
				   </div>
                   </div>
	    ...
	    <div class="col-md-7">
				   ...
				   <div class="box border primary ">
											<div class="box-title">
												<h4><i class="fa fa-bars"></i><?php echo ($renwu2["if_theme"]); ?></h4>
												<div class="tools hidden-xs">
                                           ...
                                           <div class="box-body big">
                                             <div class="p-sm">
			    <p class="vertical-date text-success"><small>长期有效</small></p>
			    <p><?php echo ($renwu2["if_content"]); ?></p>
			</div>
                         <?php if($renwu2["if_webimg"] != ''): ?><p><img alt="" src="<?php echo ($renwu2["if_webimg"]); ?>" style="width:250px;height:200px;"></p><?php endif; ?><br>
					 </div>
				   </div>
                   </div>
    ...
    <div class="col-md-5">
				   ...
				   <div class="box border primary ">
											<div class="box-title">
												<h4><i class="fa fa-bars"></i><span class="heading">完成任务，提交凭证截图</span></h4>
												<div class="tools hidden-xs">
                                           ...
                                           <div class="box-body big">
                                             <form class="form-horizontal margin-none" action="<?php echo U('Home/Myuser/taskcl');?>" name="xgmm" id="xgmm" method="post">
		<div class="widget-body">
		    ...
		    <?php if($allDone): ?><p class="text-success">当天已经提交过任务，请明天再来！</p>
		    <?php else: ?>
			<p>必须上传截图凭证，任务才能通过审核！</p>
			<a class="btn btn-info btn-sm" id="btn">上传截图凭证</a> <input name="" class="btn btn-primary btn-sm" type="submit" id="btn" value="提交审核">
			<script type="text/javascript" src="/js/xz/jquery.js"></script>
			<script type="text/javascript" src="/plupload/plupload.full.min.js"></script>
			<script type="text/javascript" src="/js/xz/sucaihuo.js"></script><?php endif; ?>
		    </div>
		</div>
	    </form>
					 </div>
    ...
    <div class="col-md-7">
				   ...
				   <div class="box border primary ">
											<div class="box-title">
												<h4><i class="fa fa-bars"></i>排单币任务记录</h4>
												<div class="tools hidden-xs">
