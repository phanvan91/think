...
<div class="container">
				<div class="row">
				  <div id="content" class="col-lg-12">
				   ...
				   <div class="box border primary ">
											<div class="box-title">
												<h4><i class="fa fa-bars"></i>抢单列表</h4>
										   ...
										   <p>
										   <?php if($timer != ''): ?>抢单时间剩余：<span id="starttime" style="color:red;"></span><?php endif; ?>
										   
										   <?php if($flag == 1): ?>抢单时间未开始<?php endif; ?> <?php if($flag == 2): ?>抢单时间已结束<?php endif; ?>&nbsp;&nbsp;&nbsp;本月抢单<?php echo ($tgbzall); ?>次 </p>
			...
			<tbody>
			    <?php if(is_array($list)): foreach($list as $key=>$v): ?><tr role="row" class="odd">
			      ...
			      <td><?php echo ($v["jb"]); ?></td>
			      <td><a href="/Home/Order/getOrder/id/<?php echo ($v["id"]); ?>" style="color:#FF0000">我要抢单</a></td>
