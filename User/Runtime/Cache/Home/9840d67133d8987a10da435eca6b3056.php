...
<div class="container">
				<div class="row">
				  <div id="content" class="col-lg-12">
				   ...
				   <div class="box border primary ">
											<div class="box-title">
												<h4><i class="fa fa-bars"></i>商品列表</h4>
    ...
    <form action="/index.php/Home/Good/order"  enctype="multipart/form-data" name="xgmm" id="xgmm" method="post">
    ...
    <div class="widget-body">
      <ul class="goodlist">
		   <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
				 <!-- <input type="checkbox" name="goodid[]" value="<?php echo ($vo["goodid"]); ?>" /> -->
				 <input type="hidden" name="price[]" value="<?php echo ($vo["price"]); ?>" />
				 <input type="hidden" name="goodname[]" value="<?php echo ($vo["goodname"]); ?>" />
				 <input type="hidden" name="zhituinum[]" value="<?php echo ($vo["zhituinum"]); ?>" />
				 <a href="<?php echo U('Good/info',array('id'=>$vo['goodid']));?>">
				 <img src="<?php echo ($vo["imgpath"]); ?>" style="margin-top:10px;width:100px;height:50px;" />商品名称：<?php echo ($vo["goodname"]); ?> 商品价格：<?php echo ($vo["price"]); ?>
				 
				 </a>
				 <!-- <span style="float:right;margin-right:30px;">数量<font style="font-size:24px;" onclick="jian(<?php echo ($vo["goodid"]); ?>)">-</font>
				 <input type="text" style="width:30px;line-height:30px;height:30px;vertical-align:middle;text-align:center;" name="goodsnum[]" value="0" id="good<?php echo ($vo["goodid"]); ?>" />
				 <font style="font-size:20px;" onclick="jia(<?php echo ($vo["goodid"]); ?>)">+</font></span> -->
			 </li>
			 <div style="clear:both;"></div><?php endforeach; endif; else: echo "" ;endif; ?>
	       <p style="margin-top:30px;"> <a href="<?php echo U('Myuser/lxwm');?>">我要开店</a></p>
           <!-- <p>联系电话：<input type="text" name="tel" /></p>
		   <p><input type="submit" name="tijiao" value="购买商品" /></p> -->
	  </ul>
