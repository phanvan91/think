				...
				<div class="row">
				  <div id="content" class="col-lg-12">
				   ...
				   <div class="box border primary ">
											<div class="box-title">
												<h4><i class="fa fa-bars"></i>认筹通道</h4>
                          ...
                          <?php if($flag == 1): ?><img src="/Public/erweima/1000.jpg"  style="width:500px;height:500px;" /><?php endif; ?>
						  
						  <?php if($flag == 2): ?><img src="/Public/erweima/3000.jpg"  style="width:500px;height:500px;"/><?php endif; ?>
						  
						  <?php if($flag == 3): ?><img src="/Public/erweima/5000.jpg" style="width:500px;height:500px;" /><?php endif; ?>
						  
						  <?php if($flag == 4): ?><img src="/Public/erweima/8000.jpg" style="width:500px;height:500px;" /><?php endif; ?>
						  
						  <?php if($flag == 5): ?><img src="/Public/erweima/10000.jpg" style="width:500px;height:500px;" /><?php endif; ?>
						  
                             <input type="button" onclick="javascript:window.location.href='/Home/Myuser/lxwm/flag/1'" value="我已认筹，跳转提交" />
						</div>
				   </div>
                   </div>
                  </div>
...
function timer(intDiff){
	...
	if(intDiff > 0){
		...
		if (minute <= 9) minute = '0' + minute;
			...
			$('#starttime').html(day+"天"+'<s id="h"></s>'+hour+'时'+'<s></s>'+minute+'分'+'<s></s>'+second+'秒');
