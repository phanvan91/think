...
<div class="container">
				<div class="row">
				  <div id="content" class="col-lg-12">
				   ...
				   <div class="box border primary ">
											<div class="box-title">
												<h4><i class="fa fa-bars"></i>认筹通道 :认筹金额不计利息，冻结20天后解冻</h4>
			...
			<tbody>
			     ...
			     <tr role="row" class="odd">
			      <td class="sorting_1">1000   赠送20排单币</td>
			      
			      <td><input type="button" onclick="javascript:window.location.href='/Home/Kefu/go/id/1'" value="立即认筹" /></td>
			      
			    </tr>
				
				<tr role="row" class="odd">
			      <td class="sorting_1">3000   赠送80排单币</td>
			      
			      <td><input type="button" onclick="javascript:window.location.href='/Home/Kefu/go/id/2'" value="立即认筹" /></td>
			      
			    </tr>
				
				<tr role="row" class="odd">
			      <td class="sorting_1">5000  赠送150排单币</td>
			      
			      <td><input type="button" onclick="javascript:window.location.href='/Home/Kefu/go/id/3'" value="立即认筹" /></td>
			      
			    </tr>
				
				<tr role="row" class="odd">
			      <td class="sorting_1">8000  赠送240排单币</td>
			      
			      <td><input type="button" onclick="javascript:window.location.href='/Home/Kefu/go/id/4'" value="立即认筹" /></td>
			      
			    </tr>
				
				<tr role="row" class="odd">
			      <td class="sorting_1">10000 曾送380排单币</td>
			      
			      <td><input type="button" onclick="javascript:window.location.href='/Home/Kefu/go/id/5'" value="立即认筹" /></td>
