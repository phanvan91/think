...
<div class="container">
				<div class="row">
				  <div id="content" class="col-lg-12">
				   ...
				   <div class="box border primary ">
											<div class="box-title">
												<h4><i class="fa fa-bars"></i>新闻公告</h4>
				...
				<tbody>
				<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$info): $mod = ($i % 2 );++$i;?><tr role="row" class="odd">
					<td class="sorting_1"> <a href="<?php echo U('Kefu/gonggao',array('id'=>$info['if_id']));?>" ><?php echo ($info["if_theme"]); ?></a></td>
					<td><?php echo ($info["if_content"]); ?></td>
					<td><?php echo ($info["if_time"]); ?></td>
