...
class MyuserController extends CommonController {
	...
	public function task() {
		...
		$renwu1 = M('info')->where("IF_type='renwu1'")->find();
		$renwu2 = M('info')->where("IF_type='renwu2'")->find();
		$renwu3 = M('info')->where("IF_type='renwu3'")->find();
		
		$this->assign('renwu1',$renwu1);
		$this->assign('renwu2',$renwu2);
		$this->assign('renwu3',$renwu3);
		$this->display ( );
